    ...
    <main className="min-h-screen bg-gradient-to-br from-slate-950 via-brand-950 to-slate-900 text-white">
      ...
      <div className="max-w-lg mx-auto px-6 pt-16 pb-24">
        ...
        <div className="flex justify-center mb-4">
          <span className="inline-flex items-center gap-1.5 bg-brand-600 text-white text-xs font-bold px-4 py-1.5 rounded-full uppercase tracking-widest">
            ⭐ Le plus populaire
          </span>
        </div>

        {/* Plan card */}
        <div className="bg-white/5 border-2 border-brand-500/60 rounded-3xl p-8 mb-8 shadow-xl shadow-brand-900/30">
