  ...
  return (
    <main
      style={{
        ...
        padding: "24px 16px",
        background:
          "radial-gradient(circle at top, rgba(248, 113, 113, 0.12), transparent 28%), var(--bg-base)",
      }}
    >
      <section
        style={{
      ...
      >
        ...
        >
          Cliquez sur recharger. Si le probleme persiste, relancez une analyse depuis la page principale.
